...
int main(int argc, char* argv[])
{
	...
	Texture *sk = texturePool->load_texture("models/timg.jpg");
	//载入模型
	...
	NodePath sf = window->load_model(window->get_render(), "models/sf.egg");
	sf.set_scale(20);
	sf.set_pos(-150,100, 150);
	...
	PT(TextureStage) textureStage = TextureStage::get_default();



	sf.set_tex_gen(textureStage, TexGenAttrib::M_eye_normal);
